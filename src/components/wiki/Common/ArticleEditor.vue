  ...
  <section :class="{ 'editor-active': !postSaved}">
    ...
    <div class="clearfix">
      <div class="half-container">
        ...
        <span class="tag" v-for="tag in tags" :key="tag">{{tag['name']}} <i class="icon-chacha iconfont delete-tag" @click="deleteTag(tag.id)"></i></span>
        <div class="tag active">
          ...
          <ul class="search-list reset-list" v-if="tagInput" v-show="tagsToAdd.length">
            <li class="search-item" @click="submitTag(tag['name'])" v-for="tag in tagsToAdd" :key="tag">{{tag['name']}}</li>
          </ul>
        </div>
      </div>
      <div class="half-container">
